/**
 * Barrel for `/saham` route-specific widgets. These components are used
 * only by the Saham page, so they're grouped here rather than in the
 * shared `@/components` root. Import from `@/components/saham`:
 *
