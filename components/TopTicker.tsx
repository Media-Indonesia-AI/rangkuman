          ...
          variant === "crypto"
            ? COINS.map((c, idx) => (
                <a
                  ...
                  href={`/sorotan/detail/${c.kode === "BTC" ? "cr-btc-2026-06-07" : c.kode === "ETH" ? "cr-eth-2026-06-07" : c.kode === "SOL" ? "cr-sol-2026-06-07" : c.kode === "FET" ? "cr-fet-2026-06-07" : c.kode === "LINK" ? "cr-link-2026-06-07" : c.kode === "DOGE" ? "cr-doge-2026-06-07" : ""}`}
