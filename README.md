...
│   ├── page.tsx                      # Home: Headline + Berita Terkini
...
│   │
│   ├── StoryHero.tsx                 # 1 big card (Headline)
...
Lihat `lib/highlight.ts` untuk type schema (`Highlight`, `StoryEvent`, `Category`, `CATEGORY_CONFIG`). Story datanya sendiri datang dari `useHeadlines` / `useHeadlineId` — tidak ada mock catalog lagi.
...
- Dynamic routes: `/stock/[kode]` (34), `/sektor/[slug]` (12), `/headline/detail/[id]` (50), `/kebijakan/[slug]` (8)
...
### Public
- `/` — Home (Headline + Berita Terkini)
- `/headline/detail/[id]/` — 50 story detail pages
...
| `/headline/detail/[id]/` | 120 kB (50 pages) |
