...
/**
 * `/page-sitemap.xml/` — static page URLs (home, saham, crypto,
 * trending, story topic pages, legal pages).
 *
 * See `app/sitemap.xml/route.ts` for the full rationale on why
 * this is a route handler instead of `app/page-sitemap.xml.ts`
...
export async function GET() {
  const filePath = join(process.cwd(), "public", "page-sitemap.xml");
